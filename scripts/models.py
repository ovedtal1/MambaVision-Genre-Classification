...
class MambaVisionModel(nn.Module):
    def __init__(self,augmantations=None):
        ...
        self.MambaVision = AutoModel.from_pretrained("nvidia/MambaVision-T-1K", trust_remote_code=True).cuda()
        ...
        self.output = nn.Sequential(nn.Linear(in_features=1024, out_features=10)).cuda()
